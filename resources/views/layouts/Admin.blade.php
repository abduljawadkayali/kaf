...
<body class="hold-transition sidebar-mini">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4" style=" position: fixed!important; height: 100%!important;"  >
        ...
        <a href="/" class="brand-link">
            <span style="text-align: center!important;" class="brand-text font-weight-light">@lang("KAF")</span>
    ...
    <footer class="main-footer">
        <strong>@lang("Copyright") &copy; 2014-2019 <a href="/">@lang("KafCode")</a>.</strong>
